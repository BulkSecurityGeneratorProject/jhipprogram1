...
public class Jhipprogram1App {

    private static final Logger log = LoggerFactory.getLogger(Jhipprogram1App.class);

    private final Environment env;

    public Jhipprogram1App(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipprogram1.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Jhipprogram1App.class);
